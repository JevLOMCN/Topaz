    ...
    $.fn.fullpage = function(options) {
        ...
        function setAutoScrolling(value, type){
            ...
            if(options.autoScrolling && !options.scrollBar){
                ...
                if(element.length){
                    ...
                    silentScroll(element.position().left);
                }
                ...
                if (element.length) {
                    $htmlBody.scrollTop(element.position().left);
                }
            }
        }
        ...
        */
        function isCompletelyInViewPort(movement){
            var top = $(SECTION_ACTIVE_SEL).position().left;
        ...
        */
        function getDestinationPosition(element){
            ...
            var isScrollingDown =  elemPosition.left > previousDestTop; // 수정
        ...
        */
        function performMovement(v){
            ...
            if (options.css3 && options.autoScrolling && !options.scrollBar) {
                ...
                var translate3d = 'translate3d(-'+ Math.round(v.dtop) +'px,0px,0px)'; //수정2
        ...
        */
        function createInfiniteSections(v){
            ...
            silentScroll($(SECTION_ACTIVE_SEL).position().left);
            ...
            v.dtop = v.element.position().left;
