namespace Server_Console.Database
{
    partial class DatabaseForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            TutorialBox = new GroupBox();
            TutorialClearTable = new DataGridView();
            WaypointBox = new GroupBox();
            WaypointTable = new DataGridView();
            SkillBox = new GroupBox();
            SkillPassiveTable = new DataGridView();
            SkillActiveTable = new DataGridView();
            VehicleBox = new GroupBox();
            VehicleTable = new DataGridView();
            TreasureBox = new GroupBox();
            TreasureTable = new DataGridView();
            PulseBox = new GroupBox();
            PulseBloodTable = new DataGridView();
            QuestsBox = new GroupBox();
            QuestWeeklyTable = new DataGridView();
            QuestWeeklyListTable = new DataGridView();
            QuestSubTable = new DataGridView();
            QuestDailyTable = new DataGridView();
            QuestDailyListTable = new DataGridView();
            QuestMainTable = new DataGridView();
            MailBox = new GroupBox();
            MailTable = new DataGridView();
            ItemsBox = new GroupBox();
            EquipMasteryTable = new DataGridView();
            EquipJewelTable = new DataGridView();
            CostumeTable = new DataGridView();
            EquipItemTable = new DataGridView();
            ItemCharacterTable = new DataGridView();
            AccountBox = new GroupBox();
            CharacterDeleteTable = new DataGridView();
            GameAccountTable = new DataGridView();
            ...
            TutorialBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)TutorialClearTable).BeginInit();
            WaypointBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)WaypointTable).BeginInit();
            SkillBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)SkillPassiveTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)SkillActiveTable).BeginInit();
            VehicleBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)VehicleTable).BeginInit();
            TreasureBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)TreasureTable).BeginInit();
            PulseBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)PulseBloodTable).BeginInit();
            QuestsBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)QuestWeeklyTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)QuestWeeklyListTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)QuestSubTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)QuestDailyTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)QuestDailyListTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)QuestMainTable).BeginInit();
            MailBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)MailTable).BeginInit();
            ItemsBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)EquipMasteryTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)EquipJewelTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)CostumeTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)EquipItemTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)ItemCharacterTable).BeginInit();
            AccountBox.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)CharacterDeleteTable).BeginInit();
            ((System.ComponentModel.ISupportInitialize)GameAccountTable).BeginInit();
            ...
            DatabaseTabs.Location = new Point(119, 3);
            ...
            // tabPlayerSearch
            // 
            tabPlayerSearch.Controls.Add(TutorialBox);
            tabPlayerSearch.Controls.Add(WaypointBox);
            tabPlayerSearch.Controls.Add(SkillBox);
            tabPlayerSearch.Controls.Add(VehicleBox);
            tabPlayerSearch.Controls.Add(TreasureBox);
            tabPlayerSearch.Controls.Add(PulseBox);
            tabPlayerSearch.Controls.Add(QuestsBox);
            tabPlayerSearch.Controls.Add(MailBox);
            tabPlayerSearch.Controls.Add(ItemsBox);
            ...
            // TutorialBox
            // 
            TutorialBox.Controls.Add(TutorialClearTable);
            TutorialBox.Location = new Point(1375, 7);
            TutorialBox.Name = "TutorialBox";
            TutorialBox.Size = new Size(164, 261);
            TutorialBox.TabIndex = 18;
            TutorialBox.TabStop = false;
            TutorialBox.Text = "Tutorial";
            // 
            // TutorialClearTable
            // 
            TutorialClearTable.BackgroundColor = SystemColors.Control;
            TutorialClearTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            TutorialClearTable.Location = new Point(6, 22);
            TutorialClearTable.Name = "TutorialClearTable";
            TutorialClearTable.Size = new Size(156, 230);
            TutorialClearTable.TabIndex = 14;
            // 
            // WaypointBox
            // 
            WaypointBox.Controls.Add(WaypointTable);
            WaypointBox.Location = new Point(1276, 274);
            WaypointBox.Name = "WaypointBox";
            WaypointBox.Size = new Size(164, 341);
            WaypointBox.TabIndex = 17;
            WaypointBox.TabStop = false;
            WaypointBox.Text = "Waypoint";
            // 
            // WaypointTable
            // 
            WaypointTable.BackgroundColor = SystemColors.Control;
            WaypointTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            WaypointTable.Location = new Point(6, 22);
            WaypointTable.Name = "WaypointTable";
            WaypointTable.Size = new Size(156, 313);
            WaypointTable.TabIndex = 14;
            // 
            // SkillBox
            // 
            SkillBox.Controls.Add(SkillPassiveTable);
            SkillBox.Controls.Add(SkillActiveTable);
            SkillBox.Location = new Point(896, 274);
            SkillBox.Name = "SkillBox";
            SkillBox.Size = new Size(378, 335);
            SkillBox.TabIndex = 17;
            SkillBox.TabStop = false;
            SkillBox.Text = "Skills";
            // 
            // SkillPassiveTable
            // 
            SkillPassiveTable.BackgroundColor = SystemColors.Control;
            SkillPassiveTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            SkillPassiveTable.Location = new Point(189, 22);
            SkillPassiveTable.Name = "SkillPassiveTable";
            SkillPassiveTable.Size = new Size(187, 313);
            SkillPassiveTable.TabIndex = 10;
            // 
            // SkillActiveTable
            // 
            SkillActiveTable.BackgroundColor = SystemColors.Control;
            SkillActiveTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            SkillActiveTable.Location = new Point(1, 22);
            SkillActiveTable.Name = "SkillActiveTable";
            SkillActiveTable.Size = new Size(187, 313);
            SkillActiveTable.TabIndex = 9;
            // 
            // VehicleBox
            // 
            VehicleBox.Controls.Add(VehicleTable);
            VehicleBox.Location = new Point(1444, 274);
            VehicleBox.Name = "VehicleBox";
            VehicleBox.Size = new Size(164, 341);
            VehicleBox.TabIndex = 16;
            VehicleBox.TabStop = false;
            VehicleBox.Text = "Vehicle";
            // 
            // VehicleTable
            // 
            VehicleTable.BackgroundColor = SystemColors.Control;
            VehicleTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            VehicleTable.Location = new Point(6, 22);
            VehicleTable.Name = "VehicleTable";
            VehicleTable.Size = new Size(156, 313);
            VehicleTable.TabIndex = 14;
            // 
            // TreasureBox
            // 
            TreasureBox.Controls.Add(TreasureTable);
            TreasureBox.Location = new Point(1375, 615);
            TreasureBox.Name = "TreasureBox";
            TreasureBox.Size = new Size(164, 341);
            TreasureBox.TabIndex = 15;
            TreasureBox.TabStop = false;
            TreasureBox.Text = "Treasure";
            // 
            // TreasureTable
            // 
            TreasureTable.BackgroundColor = SystemColors.Control;
            TreasureTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            TreasureTable.Location = new Point(6, 22);
            TreasureTable.Name = "TreasureTable";
            TreasureTable.Size = new Size(156, 313);
            TreasureTable.TabIndex = 14;
            // 
            // PulseBox
            // 
            PulseBox.Controls.Add(PulseBloodTable);
            PulseBox.Location = new Point(1207, 615);
            PulseBox.Name = "PulseBox";
            PulseBox.Size = new Size(164, 341);
            PulseBox.TabIndex = 5;
            PulseBox.TabStop = false;
            PulseBox.Text = "Pulse";
            // 
            // PulseBloodTable
            // 
            PulseBloodTable.BackgroundColor = SystemColors.Control;
            PulseBloodTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            PulseBloodTable.Location = new Point(6, 22);
            PulseBloodTable.Name = "PulseBloodTable";
            PulseBloodTable.Size = new Size(156, 313);
            PulseBloodTable.TabIndex = 14;
            // 
            // QuestsBox
            // 
            QuestsBox.Controls.Add(QuestWeeklyTable);
            QuestsBox.Controls.Add(QuestWeeklyListTable);
            QuestsBox.Controls.Add(QuestSubTable);
            QuestsBox.Controls.Add(QuestDailyTable);
            QuestsBox.Controls.Add(QuestDailyListTable);
            QuestsBox.Controls.Add(QuestMainTable);
            QuestsBox.Location = new Point(6, 615);
            QuestsBox.Name = "QuestsBox";
            QuestsBox.Size = new Size(1195, 341);
            QuestsBox.TabIndex = 4;
            QuestsBox.TabStop = false;
            QuestsBox.Text = "Quests";
            // 
            // QuestWeeklyTable
            // 
            QuestWeeklyTable.BackgroundColor = SystemColors.Control;
            QuestWeeklyTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            QuestWeeklyTable.Location = new Point(995, 22);
            QuestWeeklyTable.Name = "QuestWeeklyTable";
            QuestWeeklyTable.Size = new Size(198, 313);
            QuestWeeklyTable.TabIndex = 13;
            // 
            // QuestWeeklyListTable
            // 
            QuestWeeklyListTable.BackgroundColor = SystemColors.Control;
            QuestWeeklyListTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            QuestWeeklyListTable.Location = new Point(796, 22);
            QuestWeeklyListTable.Name = "QuestWeeklyListTable";
            QuestWeeklyListTable.Size = new Size(198, 313);
            QuestWeeklyListTable.TabIndex = 12;
            // 
            // QuestSubTable
            // 
            QuestSubTable.BackgroundColor = SystemColors.Control;
            QuestSubTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            QuestSubTable.Location = new Point(597, 22);
            QuestSubTable.Name = "QuestSubTable";
            QuestSubTable.Size = new Size(198, 313);
            QuestSubTable.TabIndex = 11;
            // 
            // QuestDailyTable
            // 
            QuestDailyTable.BackgroundColor = SystemColors.Control;
            QuestDailyTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            QuestDailyTable.Location = new Point(398, 22);
            QuestDailyTable.Name = "QuestDailyTable";
            QuestDailyTable.Size = new Size(198, 313);
            QuestDailyTable.TabIndex = 10;
            // 
            // QuestDailyListTable
            // 
            QuestDailyListTable.BackgroundColor = SystemColors.Control;
            QuestDailyListTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            QuestDailyListTable.Location = new Point(199, 22);
            QuestDailyListTable.Name = "QuestDailyListTable";
            QuestDailyListTable.Size = new Size(198, 313);
            QuestDailyListTable.TabIndex = 9;
            // 
            // QuestMainTable
            // 
            QuestMainTable.BackgroundColor = SystemColors.Control;
            QuestMainTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            QuestMainTable.Location = new Point(0, 22);
            QuestMainTable.Name = "QuestMainTable";
            QuestMainTable.Size = new Size(198, 313);
            QuestMainTable.TabIndex = 8;
            // 
            // MailBox
            // 
            MailBox.Controls.Add(MailTable);
            MailBox.Location = new Point(980, 7);
            MailBox.Name = "MailBox";
            MailBox.Size = new Size(391, 261);
            MailBox.TabIndex = 3;
            ...
            // MailTable
            // 
            MailTable.BackgroundColor = SystemColors.Control;
            MailTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            MailTable.Location = new Point(6, 22);
            MailTable.Name = "MailTable";
            MailTable.Size = new Size(385, 230);
            MailTable.TabIndex = 8;
            // 
            // ItemsBox
            // 
            ItemsBox.Controls.Add(EquipMasteryTable);
            ItemsBox.Controls.Add(EquipJewelTable);
            ItemsBox.Controls.Add(CostumeTable);
            ItemsBox.Controls.Add(EquipItemTable);
            ItemsBox.Controls.Add(ItemCharacterTable);
            ItemsBox.Location = new Point(6, 274);
            ItemsBox.Name = "ItemsBox";
            ItemsBox.Size = new Size(885, 341);
            ItemsBox.TabIndex = 2;
            ...
            // EquipMasteryTable
            // 
            EquipMasteryTable.BackgroundColor = SystemColors.Control;
            EquipMasteryTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            EquipMasteryTable.Location = new Point(697, 22);
            EquipMasteryTable.Name = "EquipMasteryTable";
            EquipMasteryTable.Size = new Size(187, 313);
            EquipMasteryTable.TabIndex = 8;
            // 
            // EquipJewelTable
            // 
            EquipJewelTable.BackgroundColor = SystemColors.Control;
            EquipJewelTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            EquipJewelTable.Location = new Point(509, 22);
            EquipJewelTable.Name = "EquipJewelTable";
            EquipJewelTable.Size = new Size(187, 313);
            EquipJewelTable.TabIndex = 7;
            // 
            // CostumeTable
            // 
            CostumeTable.BackgroundColor = SystemColors.Control;
            CostumeTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            CostumeTable.Location = new Point(321, 22);
            CostumeTable.Name = "CostumeTable";
            CostumeTable.Size = new Size(187, 313);
            CostumeTable.TabIndex = 6;
            // 
            // EquipItemTable
            // 
            EquipItemTable.BackgroundColor = SystemColors.Control;
            EquipItemTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            EquipItemTable.Location = new Point(133, 22);
            EquipItemTable.Name = "EquipItemTable";
            EquipItemTable.Size = new Size(187, 313);
            EquipItemTable.TabIndex = 5;
            // 
            // ItemCharacterTable
            // 
            ItemCharacterTable.BackgroundColor = SystemColors.Control;
            ItemCharacterTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            ItemCharacterTable.Location = new Point(0, 22);
            ItemCharacterTable.Name = "ItemCharacterTable";
            ItemCharacterTable.Size = new Size(132, 313);
            ItemCharacterTable.TabIndex = 4;
            // 
            // AccountBox
            // 
            AccountBox.Controls.Add(CharacterDeleteTable);
            AccountBox.Controls.Add(GameAccountTable);
            ...
            AccountBox.Size = new Size(830, 261);
            ...
            CharacterDeleteTable.Location = new Point(641, 22);
            CharacterDeleteTable.Name = "CharacterDeleteTable";
            CharacterDeleteTable.Size = new Size(187, 230);
            CharacterDeleteTable.TabIndex = 7;
            // 
            // GameAccountTable
            // 
            GameAccountTable.BackgroundColor = SystemColors.Control;
            GameAccountTable.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            GameAccountTable.Location = new Point(318, 174);
            GameAccountTable.Name = "GameAccountTable";
            GameAccountTable.Size = new Size(321, 78);
            GameAccountTable.TabIndex = 3;
            // 
            // UserTable
            // 
            ...
            UserTable.Location = new Point(0, 174);
            UserTable.Name = "UserTable";
            UserTable.Size = new Size(320, 78);
            ...
            CharacterTable.Location = new Point(0, 95);
            CharacterTable.Name = "CharacterTable";
            CharacterTable.Size = new Size(639, 78);
            ...
            FrontAccountTable.Size = new Size(639, 78);
            ...
            tableLayoutPanel1.Size = new Size(1100, 555);
            ...
            TutorialBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)TutorialClearTable).EndInit();
            WaypointBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)WaypointTable).EndInit();
            SkillBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)SkillPassiveTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)SkillActiveTable).EndInit();
            VehicleBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)VehicleTable).EndInit();
            TreasureBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)TreasureTable).EndInit();
            PulseBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)PulseBloodTable).EndInit();
            QuestsBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)QuestWeeklyTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)QuestWeeklyListTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)QuestSubTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)QuestDailyTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)QuestDailyListTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)QuestMainTable).EndInit();
            MailBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)MailTable).EndInit();
            ItemsBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)EquipMasteryTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)EquipJewelTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)CostumeTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)EquipItemTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)ItemCharacterTable).EndInit();
            AccountBox.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)CharacterDeleteTable).EndInit();
            ((System.ComponentModel.ISupportInitialize)GameAccountTable).EndInit();
        ...
        private DataGridView GameAccountTable;
        private GroupBox ItemsBox;
        private DataGridView EquipItemTable;
        private DataGridView ItemCharacterTable;
        private DataGridView EquipJewelTable;
        private DataGridView CostumeTable;
        private DataGridView CharacterDeleteTable;
        private DataGridView EquipMasteryTable;
        private GroupBox MailBox;
        private DataGridView MailTable;
        private GroupBox QuestsBox;
        private ToolStripTextBox tsm_TableDescription;
        private DataGridView QuestDailyListTable;
        private DataGridView QuestMainTable;
        private GroupBox PulseBox;
        private DataGridView QuestWeeklyTable;
        private DataGridView QuestWeeklyListTable;
        private DataGridView QuestSubTable;
        private DataGridView QuestDailyTable;
        private DataGridView PulseBloodTable;
        private GroupBox TreasureBox;
        private DataGridView TreasureTable;
        private GroupBox VehicleBox;
        private DataGridView VehicleTable;
        private GroupBox TutorialBox;
        private DataGridView TutorialClearTable;
        private GroupBox WaypointBox;
        private DataGridView WaypointTable;
